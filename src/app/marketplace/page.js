              ...
              <div className="max-h-64 overflow-y-auto divide-y divide-border-soft/50 overscroll-contain">
                {machineryList.filter(item => 
                  ...
                  <button
                    ...
                    className="w-full p-2.5 text-left hover:bg-surface-container-low transition-colors flex items-start gap-2.5 group"
                  >
                    <div className="w-8 h-8 rounded-lg bg-primary/10 text-primary flex items-center justify-center shrink-0 group-hover:bg-primary group-hover:text-white transition-colors">
                      <span className="material-symbols-outlined text-[18px]">{item.imageIcon}</span>
                    </div>
